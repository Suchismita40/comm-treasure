...
// Initial state with milestone escrow metadata for Treasury Core Contract
let mockTreasuryState: TreasuryStats = {
  totalBalance: 45000.0,
  totalProposals: 4,
  activeProposals: 2,
  totalExecuted: 2,
  admin: "GADMINSTELLARTESTNETCOMMUNITYTREASURYADMIN0123456789",
  memberCount: 148,
};
...
let mockProposals: Proposal[] = [
  {
    id: 1,
    creator: "GADMINSTELLARTESTNETCOMMUNITYTREASURYADMIN0123456789",
...
let mockEvents: TreasuryEvent[] = [
  {
    ...
    walletAddress: "GADMINSTELLARTESTNETCOMMUNITYTREASURYADMIN0123456789",
...
export class TreasuryContractClient {
  ...
  /**
   * Soroban Function: get_state(env: Env) -> TreasuryState
   */
  ...
  /**
   * Soroban Function: initialize(env: Env, admin: Address)
   */
  ...
  /**
   * Soroban Function: deposit(env: Env, from: Address, amount: i128)
   */
  ...
  /**
   * Soroban Function: create_proposal(env: Env, creator: Address, title: String, description: String, recipient: Address, amount: i128, duration_ledgers: u32, milestone_count: u32) -> u32
   */
  ...
  /**
   * Soroban Function: vote(env: Env, voter: Address, proposal_id: u32, approve: bool)
   */
  ...
  /**
   * Soroban Function: execute_proposal(env: Env, executor: Address, proposal_id: u32)
   */
  ...
  /**
   * Soroban Function: release_milestone(env: Env, executor: Address, proposal_id: u32)
   */
  ...
  /**
   * Soroban Function: reward_reviewer(env: Env, caller_contract: Address, reviewer: Address, reward_amount: i128)
   */
