export const STELLAR_CONFIG = {
  ...
  // Specific Soroban Contract Addresses on Stellar Testnet (Valid StrKey Checksums)
  treasuryCoreContractId:
    process.env.NEXT_PUBLIC_TREASURY_CORE_CONTRACT_ID ||
    "CAFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUTSM",
  communityReviewsContractId:
    process.env.NEXT_PUBLIC_COMMUNITY_REVIEWS_CONTRACT_ID ||
    "CAKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBIFAUCQKBJRD5",
  xlmTokenContractId:
    process.env.NEXT_PUBLIC_XLM_TOKEN_CONTRACT_ID ||
    "CAPB4HQ6DYPB4HQ6DYPB4HQ6DYPB4HQ6DYPB4HQ6DYPB4HQ6DYPB4QTN",
